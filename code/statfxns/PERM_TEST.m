function [pvals_twotail] = PERM_TEST(A,B,nperms,fxn)
    ...
    % fxn: function to compute over N rows of A and B -- either median or mean.
    ...
    observedA_gt_B = repmat(fxn(A) - fxn(B),[nperms 1 1]);
